...
出力: data/bloodline/sire_lines.toon
"""
import json
import sys
...
OUTPUT_PATH = Path(__file__).resolve().parents[1] / "bloodline" / "sire_lines.toon"
...
def main():
    ...
    print(f"\n3. {OUTPUT_PATH} に出力...")
    OUTPUT_PATH.write_text(toon.encode(result), encoding="utf-8")
    print("完了!")
